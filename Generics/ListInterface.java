...
public interface ListInterface<E extends Comparable<E>> {
    ...
    /**
     * This method adds the item at a particular index after moving
     * all the elements to the right position by one.
     * @param index where the element to be added
     * @param item to be added at a particular index.
     * @throws InvalidIndexException if index is not in the range of 
     * 0 and size-1
     */
