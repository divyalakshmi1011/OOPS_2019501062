...
class ContactsManager {
    ...
    ContactsManager() {
        int friendsCount = 0;
        int size = 500;
        Contact myFriends = new Contact[size];
    ...
    /**
     * This method search for the contact based on the
     * name of your friend and gives the
     * first occurance of the contact in your friends list.
     * @param searchName , the name of the contact to be
     ...
     * @param searchName , the email of the contact to be
     *  searched in the friends list.
     * @return the contact of the friend, null otherwise.
     */
    ...
    /**
     * This method deletes the contact based on the
     * name of your friend and returns
     * true on success and false if failure in deleting the contact.
     *
     * @param searchName , the name of the contact
     * to be searched in the friends list.
     * @return true if contact has been removed
